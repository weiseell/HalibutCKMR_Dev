...
dat$la_means_SA <- MeanLength_SA
dat$la_sd_SA <- SDLength_SA
...
#fecundity functions
dat$la_shape_SA <- Shape_SA
dat$la_scale_SA <- Scale_SA

# precalculated length at age
dat$LenatB2_SYLAB <- LenatB2_SYLAB
